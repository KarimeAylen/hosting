...
async function predict_animal()
{
	...
	animals = ["Abeja","Catarina","Cerdito","Chimpance","Delfin","Hormiga","Leon","Luciernaga", "Mariposa", "Panda"]
	...
	pred.data()
	    .then((data) => {console.log(data)
			...
			document.getElementById("output_text").innerHTML = "<p>El animal detectado y su probabilidad corresponde </p><p>Animal detectado: " + ANIMAL_DETECTADO + " ( " + (max_val*100).toFixed(2) + "% probabilidad )</p>"
	})	
